  ...
  return (
    <div className="h-128 md:h-200 w-full relative">
      ...
      <div className="absolute top-12 left-8 md:bottom-1/3 md:left-32">
        <h5 className="font-bold text-white text-left md:pl-1 mb-2">SEP 25 - SEP 28, HELSINKI</h5>
        ...
        >
          3rd edition of the Bachata Underground XXL! Workshops with international teachers, three nights of parties!
        </motion.p>
      </div>
    </div>
  )
